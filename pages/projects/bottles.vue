  ...
  <div class="text-center">
    ...
    <div class="flex flex-row flex-nowrap justify-center">
      ...
      <div class="shrink basis-2/3">
        ...
        <p> It's a new way of using Wine, the Windows emulator, that doesn't require any configuration. </p>
        <p> It's based on the Flatpak technology, so it's easy to install and it's sandboxed. </p>
        <p> My purpose within the project is to manage the entire IT infrastructure, from the mirrors scattered around the world (Canada, Japan, Italy, Europe, and many others) to creating a software that is responsible for making the redirect to the nearest mirror in less than 5 milliseconds. </p>
